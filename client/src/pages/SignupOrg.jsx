      ...
      <div className="auth-form-side">
        <div className="auth-card auth-card-register">
          <div className="auth-card-header">
            ...
            <p>Tailored to your sector and regulator from day one</p>
          </div>
          ...
          <form onSubmit={step === 3 ? handleSubmit : (e) => { e.preventDefault(); step === 1 ? goStep2() : goStep3(); }}>
            ...
            <div className={`reg-panel ${step === 1 ? 'visible' : 'hidden'} ${dir}`}>
              <div className="auth-field">
                ...
                <div className="auth-input-wrap">
                  ...
                  <input className="auth-input" value={form.org_name} onChange={e => set('org_name', e.target.value)} placeholder="e.g. Acme Manufacturing" />
                </div>
              </div>
            ...
            <div className={`reg-panel ${step === 2 ? 'visible' : 'hidden'} ${dir}`}>
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                <button className="btn btn-secondary" type="button" onClick={() => goBack(1)} style={{ padding: '0 20px', gap: 4 }}>
            ...
            <div className={`reg-panel ${step === 3 ? 'visible' : 'hidden'} ${dir}`}>
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                <button className="btn btn-secondary" type="button" onClick={() => goBack(2)} style={{ padding: '0 20px', gap: 4 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M14 7l-5 5 5 5V7z"/></svg>
                  Back
                </button>
