...
| **13** | **WI-09 Generic Incident PDF** | **Next.** No hallucination gate. Universal fallback per PRD §4.6. |
| 13+ | WI-06 PDF renderer (follow-up), WI-05 RIDDOR F2508 (still gated) | Order may shift on gate readiness. |
